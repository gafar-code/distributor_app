...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    distributorAppAuthUserSubject.add(
      DistributorAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<DistributorAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  DistributorAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = DistributorAppAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    distributorAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
DistributorAppAuthUser? currentUser;
